...
import { PlayIcon, FileIcon, InfoIcon } from './ui/Icons.jsx';
import { t } from '../lib/i18n.js';

export function Header({ preset, onPreset, onLoadFile, onProcess, busy }) {
  return (
    <header class="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white px-4 py-3 shadow-sm sm:px-6">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <Button variant="primary" icon={PlayIcon} loading={busy} onClick={onProcess}>
